...
INTVCN0_IRQHandler
                ...
                PUBWEAK INTVCN1_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTVCN1_IRQHandler
                B       INTVCN1_IRQHandler
...
INTVCT0_IRQHandler
                ...
                PUBWEAK INTVCT1_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTVCT1_IRQHandler
                B       INTVCT1_IRQHandler
...
INTCANGB_IRQHandler
                ...
                PUBWEAK INTTB80_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTB80_IRQHandler
                B       INTTB80_IRQHandler

                PUBWEAK INTTB81_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTB81_IRQHandler
                B       INTTB81_IRQHandler

                PUBWEAK INTTB90_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTB90_IRQHandler
                B       INTTB90_IRQHandler

                PUBWEAK INTTB91_IRQHandler
                SECTION .text:CODE:REORDER:NOROOT(1)
INTTB91_IRQHandler
                B       INTTB91_IRQHandler
