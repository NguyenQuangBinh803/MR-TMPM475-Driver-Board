...
#ifndef __TMPM475_UART_H
#define __TMPM475_UART_H
...
#define UART_DIVIDE_1_1             ((uint8_t)0x00)
#define UART_DIVIDE_1_2             ((uint8_t)0x01)
...
#define IS_UART_INPUTCLK_DIVIDE_LEVEL(param)  (((param) == UART_DIVIDE_1_1) || \
                                               ((param) == UART_DIVIDE_1_2))
