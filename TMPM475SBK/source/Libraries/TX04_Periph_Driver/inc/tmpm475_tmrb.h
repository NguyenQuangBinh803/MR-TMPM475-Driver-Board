...
#ifndef __TMPM475_TMRB_H
#define __TMPM475_TMRB_H
...
#define IS_TMRB_CAPTURE_PERIPH(param) (((param) == TSB_TB0) || \
                                       ((param) == TSB_TB1) || \
                                       ((param) == TSB_TB2) || \
                                       ((param) == TSB_TB3) || \
                                       ((param) == TSB_TB4) || \
...
#define IS_TMRB_OUT_PERIPH(param)    (((param) == TSB_TB0) || \
                                      ((param) == TSB_TB1) || \
                                      ((param) == TSB_TB2) || \
                                      ((param) == TSB_TB3) || \
                                      ((param) == TSB_TB4) || \
...
#define TMRB_CAPTURE_TIMPLS_RISING_FALLING  ((uint32_t)0x00000030)
#define IS_TMRB_CAPTURE_IN_TIMING(param)    (((param) == TMRB_DISABLE_CAPTURE) || \
                                             ((param) == TMRB_CAPTURE_IN_RISING) || \
                                             ((param) == TMRB_CAPTURE_IN_RISING_FALLING))

#define IS_TMRB_CAPTURE_TIMPLS_TIMING(param)(((param) == TMRB_DISABLE_CAPTURE) || \
                                             ((param) == TMRB_CAPTURE_IN_RISING) || \
                                             ((param) == TMRB_CAPTURE_IN_RISING_FALLING) || \
                                             ((param) == TMRB_CAPTURE_TIMPLS_RISING_FALLING))
...
#define TMRB_WRITE_REG_SIMULTANEOUS   ((uint8_t)0x80)
