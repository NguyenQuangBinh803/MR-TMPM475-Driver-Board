...
#ifndef __TMPM475_GPIO_H
#define __TMPM475_GPIO_H
...
/** @brief :The maximum number of the Function Register
  * Note for porting:
  * If functiong register 3 is the maximum number in 
  * all the GPIO port,then define FRMAX (3U)
  */
#define FRMAX  (3U)             /* the max number of Port I/O function register is 3 */


/** @brief: define for function register
  * Note for porting:
  * If the maximum number of the function Register is 3,
  * then you need to define 3 GPIO_FUNC_REG_x ,
  * the value should be increased from 0 to 2
  */
...
#define IS_GPIO_PORT(param)             ((param) <= GPIO_PP)    /*parameter checking for port number */
